...
/obj/item/tool/material/ashtray
	name = "ashtray"
...
/obj/item/tool/material/ashtray/New(var/newloc, var/material_name)
...
/obj/item/tool/material/ashtray/update_icon()
	color = null
	cut_overlays()
...
/obj/item/tool/material/ashtray/attackby(obj/item/W as obj, mob/user as mob)
	if (health <= 0)
		return
