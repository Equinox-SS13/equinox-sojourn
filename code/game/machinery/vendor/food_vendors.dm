...
/obj/machinery/vending/dinnerware
	...
	products = list(/obj/item/tray = 8,
					erial/kitchen/utensil/fork = 6,
					/obj/item/tool/knife = 6,
					erial/kitchen/utensil/spoon = 6,
					erial/kitchen/rollingpin = 3,
					/obj/item/spatula = 6,
...
/obj/machinery/vending/dinnerware/cost //So we can place these around and charge people
	...
	prices = list(/obj/item/tray = 35,
					erial/kitchen/utensil/fork = 3,
					/obj/item/tool/knife = 35,
					erial/kitchen/utensil/spoon = 3,
					erial/kitchen/rollingpin = 9,
					/obj/item/spatula = 12,
