...
//A vial-loaded hypospray with hot-swap capabilities, much like the actual hypospray. Much smoother and nicer to use.
/obj/item/hypospray/mkii
	name = "MID 'Apollo'"
	icon_state = "hypo"
	icon = 'modular_sojourn/hypospray_mk2/icons/syringe.dmi'
	...
	desc = "The Medical Injection Device 'Apollo' is a mass-produced, reverse-engineered variant of the MID 'Hecate'. It takes 45-unit cartridges as the drug supply for easy swapping and is equipped with a miniature scanner to prevent overdoses."
...
/obj/item/hypospray/mkii/CMO
	...
	icon_state = "cmohypo"
	desc = "The  original Medical Injection Device 'Hecate'. Its origin remains unknown, having been located under anomalous conditions, but remains in use by the chief medical officer. It can take 90-unit cartridges, acts faster, and delivers more reagents per injection than the mass-production version. Like its younger brother, it comes equipped with a miniature scanner to prevent overdoses."
	unacidable = 1
...
/obj/item/hypospray/mkii/combat
	name = "MID 'Ares'"
	desc = "A combat casualty care oriented copy of the MID 'Hecate', the Ares has had its safety protocals torn out, allowing it to act almost instantly. It can be tactically reloaded by using a vial on it. Designed for military engagements, patent pending."
...
/obj/item/hypospray/mkii/attack(mob/living/M as mob, mob/user as mob)
	...
	playsound(loc, long_sound ? 'modular_sojourn/hypospray_mk2/sound/hypospray_long.ogg' : pick('modular_sojourn/hypospray_mk2/sound/hypospray.ogg','modular_sojourn/hypospray_mk2/sound/hypospray2.ogg'), 50, 1, -1)
