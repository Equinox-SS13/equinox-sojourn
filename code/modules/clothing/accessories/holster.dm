...
/obj/item/clothing/accessory/holster/saber/saya
	...
	overlay_state = "saya"
	slot = "utility"
	can_hold = list(/obj/item/tool/sword/katana_makeshift, /obj/item/tool/sword/katana, /obj/item/tool/material/sword/katana, /obj/item/tool/sword/katana/nano, /obj/item/tool/cheap/katana) // Only straight swords.
