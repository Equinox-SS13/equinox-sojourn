/obj/item/gun/energy/sonic_emitter
	...
	desc = "A sonic weapon prototype specially designed to counter ameridian-based lifeforms by targeting the crystal's resonant frequency. It is, however, very power-intensive and slow to shoot. It take large cells."
