...
/datum/export/weapon/katana
	...
	export_types = list(/obj/item/tool/material/sword/katana)

/datum/export/weapon/katana/silver
	cost = 1000
	unit_name = "silver katana"
	export_types = list(/obj/item/tool/material/sword/katana/silver)

/datum/export/weapon/katana/gold
	cost = 1500
	unit_name = "gold katana"
	export_types = list(/obj/item/tool/material/sword/katana/gold)

/datum/export/weapon/katana/diamond
	cost = 2500
	unit_name = "diamond katana"
	export_types = list(/obj/item/tool/material/sword/katana/diamond)

/datum/export/weapon/katana/plastic
	cost = 100
	unit_name = "plastic katana"
	export_types = list(/obj/item/tool/material/sword/katana/plastic)

/datum/export/weapon/katana/platinum
	cost = 3000
	unit_name = "platinum katana"
	export_types = list(/obj/item/tool/material/sword/katana/platinum)

/datum/export/weapon/katana/plasteel
	cost = 750
	unit_name = "plasteel katana"
	export_types = list(/obj/item/tool/material/sword/katana/plasteel)

/datum/export/weapon/katana/uranium
	cost = 2000
	unit_name = "uranium katana"
	export_types = list(/obj/item/tool/material/sword/katana/uranium)

/datum/export/weapon/katana/iron
	cost = 250
	unit_name = "iron katana"
	export_types = list(/obj/item/tool/material/sword/iron)
