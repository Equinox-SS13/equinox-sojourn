...
/obj/random/knife/item_to_spawn()
	return pickweight(list(/obj/item/tool/material/butterfly = 1,
				/obj/item/tool/material/butterfly/switchblade = 2,
...
/obj/random/mat_katana/item_to_spawn()
	return pickweight(list(/obj/item/tool/material/sword/katana = 2,
				/obj/item/tool/material/sword/katana/iron = 3,
				/obj/item/tool/material/sword/katana/plasteel = 3,
				/obj/item/tool/material/sword/katana/silver = 2,
				/obj/item/tool/material/sword/katana/gold = 2,
				/obj/item/tool/material/sword/katana/platinum = 1,
				/obj/item/tool/material/sword/katana/uranium = 1,
				/obj/item/tool/material/sword/katana/plastic = 1,
				/obj/item/tool/material/sword/katana/diamond = 0.1))
...
/obj/random/claymore/item_to_spawn()
	return pickweight(list(/obj/item/tool/material/sword = 2,
				/obj/item/tool/material/sword/iron = 3,
				/obj/item/tool/material/sword/plasteel = 3,
				/obj/item/tool/material/sword/silver = 2,
				/obj/item/tool/material/sword/gold = 2,
				/obj/item/tool/material/sword/platinum = 1,
				/obj/item/tool/material/sword/uranium = 1,
				/obj/item/tool/material/sword/plastic = 1,
				/obj/item/tool/material/sword/diamond = 0.1))
...
/obj/random/melee/item_to_spawn()
	return pickweight(list(/obj/item/tool/hammer/homewrecker = 1,
				...
				/obj/item/tool/material/baseballbat = 2))
